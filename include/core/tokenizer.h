...
public:
    ...
    [[nodiscard]] int32_t eos_id() const { return eos_id_; }
    [[nodiscard]] int32_t bos_id() const { return bos_id_; }
    [[nodiscard]] int32_t pad_id() const { return pad_id_; }
    [[nodiscard]] int32_t vocab_size() const { return static_cast<int32_t>(vocab_.size()); }
